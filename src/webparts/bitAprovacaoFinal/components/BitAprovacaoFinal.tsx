...
export default class BitAprovacaoFinal extends React.Component<IBitAprovacaoFinalProps, {}> {
  ...
  public constructor(props: IBitAprovacaoFinalProps, state: IReactGetItemsState) {
    super(props);
    this.state = {
      items: [
        {
  ...
  public componentDidMount() {
    ...
    url = `${this.props.siteurl}/_api/web/lists/getbytitle('BIT')/items?$expand=Produto,Cliente,Aplicacao,Author,AprovadorGeral&$select=ID,BITNumero,Title,Status,Produto/Title,Cliente/Title,Aplicacao/Title,Segmento,Vers_x00e3_o_x0020_BIT,Author/Title,Created,AprovadorGeral/Title&$orderby= ID desc&$filter=statusInterno eq 'Aguardando Aprovação Final'`;
